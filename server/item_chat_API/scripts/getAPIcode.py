...
# Get item code from js send method
itemidcode = sys.stdin.readline()
...
Our_applicationId=1051286192578968177
...
Item=[]
#routeAPI = f"./temp/{id.split(':')[0]}.json"

#url splicing
url = f'https://app.rakuten.co.jp/services/api/IchibaItem/Search/20170706?format=json&itemCode={urllib.parse.quote(itemidcode)}&applicationId={Our_applicationId}'
#print(url)
...
#buf = json.dump(Item, ensure_ascii=False)
buf = json.dumps(Item[0])
print(buf)
        # print(imgurl3)
        # print(name)
        # print(keyword)
